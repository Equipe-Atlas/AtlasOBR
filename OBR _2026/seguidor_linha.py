...
ores_detectaveis = (Color.GREEN, Color.SILVER, Color.BLACK, Color.WHITE, Color.NONE, Color.RED)
...
def mapeia_verde(sensor):
    dados = sensor.hsv()
    return (160 <= dados.h <= 210) and (dados.s > 40) and (40 <= dados.v <= 100)
    ...
    # === SEGUE LINHA ===
        ...
        # PID normal
            ...
            if esq != Color.BLACK and meio > 50 and dir != Color.BLACK:
                ...
                integral = max(-100, min(100, integral + erro))
                derivada = erro - erro_anterior
                correcao = max(-300, min(300,
                    (kp * erro) + (ki * integral) + (kd * derivada)))
